...
public class Pong
{
   ...
   private static final int PADDLE_VERTICAL_LOW_VELOCITY_CONSTANT = 10;
   private static final int PADDLE_VERTICAL_HIGH_VELOCITY_CONSTANT = 20;
   ...
   public void displayScene()
   {
      ...
      outerRectangle.setBodyColor(
              Color.black);
      innerRectangle.setBodyColor(Color.darkGray);
      scene.setGameDisplay(innerRectangle);
      rightEdge.setBodyColor(Color.red);
      movingCircle.setRightEdge(rightEdge);
      paddle.setBodyColor(Color.green);
      ...
      JOptionPane.showMessageDialog(frame,
            "Use the numeric keys for moving the paddle. Arrow UP for going up"
            + " while Arrow DOWN for going down.");
